            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="gender_phone" class="form-control <?php echo form_error('gender_phone') ? 'is-invalid':'' ; ?>" placeholder="Telefóno" value="<?php echo set_value('gender_phone'); ?>">
                        <div class="invalid-feedback">
